...
public class Main {
	public static void main(String[] args) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
		...
		logs.log("MusicHub started", LogCat.INFO);
		...
		while (choice.charAt(0) != 'q') {
			...
			case 'h':
				logs.log("User asked for all commands", LogCat.INFO);
			...
			case 't':
				...
				logs.log("User displayed all albums titles ordered by date", LogCat.INFO);
			...
			case 'g':
				...
				logs.log("User displayed songs of " + albumTitle + " sorted by genre", LogCat.INFO);
				try {
			...
			case 'd':
				...
				albumTitle = scan.nextLine();
				logs.log("User displayed songs of " + albumTitle + " sorted by date", LogCat.INFO);
				try {
			...
			case 'u':
				...
				logs.log("User displayed all audiobooks titles ordered by author", LogCat.INFO);
			...
			case 'c':
				...
				logs.log("User added song : " + s.getTitle() + " by" + s.getArtist() + " into MusicHub!", LogCat.INFO);
				printAvailableCommands();
				choice = scan.nextLine();
				break;
			case 'a':
				...
				logs.log("User added album : " + a.getTitle() + " by" + a.getArtist() + " into MusicHub!", LogCat.INFO);
				printAvailableCommands();
				choice = scan.nextLine();
				break;
			...
			case '+':
				...
				logs.log("User added song : " + songTitle + " into album: " + titleAlbum, LogCat.INFO);
				printAvailableCommands();
				choice = scan.nextLine();
				break;
			case 'l':
				...
				logs.log("User added audiobook : " + b.getTitle() + " by" + b.getArtist() + " into MusicHub!", LogCat.INFO);
			...
			case 'f':
				...
				logs.log("User created favorite : " + fv.getTitle() + " into MusicHub!", LogCat.INFO);
				...
				while (choice.charAt(0) != 'n') {
					...
					logs.log("User added music : " + elementTitle + " into " + fv.getTitle() + " his favorite!", LogCat.INFO);
			...
			case '-':
				...
				logs.log("User deleted playlist : " + plTitle + " from MusicHub!", LogCat.INFO);
				printAvailableCommands();
				choice = scan.nextLine();
				break;
			case 's':
				...
				logs.log("User saved all content into MusicHub!", LogCat.INFO);
				printAvailableCommands();
				choice = scan.nextLine();
				break;
			case '*':
